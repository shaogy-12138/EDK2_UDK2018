...
#### Sample Applications.
  ...
  uefi/book/FileIo/FileIo.inf
  MyTest/main.inf
  #Luo2/Luo2.inf
  
  # system table
  #
  MyTest/BS/Mem/BSMemTest.inf
  MyTest/ST/ST.inf
  MyTest/systemtable/memory/BSmem.inf
  MyTest/systemtable/gRT/RT.inf
  MyTest/BS/Event/Event.inf
  ShellPkg/Application/ShellMac/main.inf     # mac debug 
